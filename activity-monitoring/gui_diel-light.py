...
style.configure("Missing.Path.TLabel",     background="#ffffff", foreground="#b42318", font=("Segoe UI", 8))
...
style.configure("Missing.Status.TLabel",   background="#f8d7da", foreground="#b42318", font=("Segoe UI", 9, "bold"))
