...
last_modified_date: 2026-08-21 18:17:23 +0000
nav_order: 1
---
...
- Raspberry Pi
    <figure class="image-row">
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Raspberry_Pi_Box.png" 
        ...
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Raspberry_Pi.png" 
...
- Entire Arducam package
  ...
  - OV5647 Arducam NOIR cut filter with white ribbon cable attached
    <figure>
        <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Arducam.png" 
  ...
  - Orange ribbon cable with two different width ends
    <figure>
        <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Orange_Ribbon_Cable.png" 
  ...
  - 2x heatsinks
    <figure>
        <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Included_Heatsinks.png" 
...
3. Take of the sticky protector on the heatsinks, and attach them to the backside of the Arducam IR Lights on the bronze circles.
    <figure>
        <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Heatsinks_Attached.png" 
...
4. With the Arducam now facing you, pull the black connection point connecting the white ribbon cable in the direction of the paper strip until the black connection point extends slightly.
    <figure class="image-row">
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/White_Black_Connector.png" 
        ...
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Black_Tab_Open.png" 
...
6. With the Arducam facing you, insert the rectangular side (wider side) of the orange ribbon cable into the black connection point, so that the gold connectors and the logo are facing towards you. 
    <figure class="image-row">
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Arducam_Orange_Correct.png" 
        ...
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Arducam_Orange_Inserted.png" 
...
7. Close the black connection point and test the mechanical connection with a few light tugs. The orange ribbon cable should not move. 
    <figure>
        <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/Black_Tab_Closed.png" 
...
9.  Locate the leftmost tan and brown connector (should look like the white and black one on the camera), and lift up the brown connection tab.
    <figure>
        <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/RPi_Connector_Circled.png" 
...
10. With the gold contacts facing left, insert the other end of the orange connector into the tan connector until it hits the bottom. It is okay if you can still see the gold connectors on the orange strip. 
    <figure class="image-row">
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/RPi_Orange_Correct.png" 
        ...
        <div>
            <img src="{{ site.baseurl }}/assets/raspberry_pi_setup/hardware/RPi_Orange_Inserted.png" 
