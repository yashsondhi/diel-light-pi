...
1. Extract data run python3 analysis_pipeline.py --conf "path_to_analysis.conf" --extract
2. Plot data quickly python3 analysis_pipeline --conf "path_to_analysis.conf" --plot_test
3. Plot complete data (slow) python3 analysis_pipeline --conf "path_to_analysis.conf" --plot_all
